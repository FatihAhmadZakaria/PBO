...
def listSplit():
    ...
    jumlah_stok=[]
    harga=[]
    with open("D:\Kuliah\Smt 2\PBO\Prak\W8\stock.txt","r+") as f:
...
def tambah_buku():
    with open("D:\Kuliah\Smt 2\PBO\Prak\W8\stock.txt", "a+") as f:
        judul = input("judul = ")
                    ...
                    while loop==True:
                        ...
                        if(choice.upper()=="Y"):
                            ...
                            if(int(jumlah_stok[a])>0):
                                ...
                                with open("D:\Kuliah\Smt 2\PBO\Prak\W8\stock.txt", "r+") as f:
                                    for i in range(8):
                                        f.wrote(judul_buku[i]+","+pengarang[i]+","+str(jumlah_stok[i])+","+"Rp"+harga[i]+"\n")
                                        success=False
                                        continue
                            else:
                                loop=False
